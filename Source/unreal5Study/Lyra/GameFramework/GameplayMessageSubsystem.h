...
UNREAL5STUDY_API DECLARE_LOG_CATEGORY_EXTERN(LogGameplayMessageSubsystem, Log, All);
...
struct UNREAL5STUDY_API FGameplayMessageListenerHandle
{
public:
	GENERATED_BODY()
 ...
 */
UCLASS()
class UNREAL5STUDY_API UGameplayMessageSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
